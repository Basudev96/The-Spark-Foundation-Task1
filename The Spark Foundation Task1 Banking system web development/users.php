...
<body>
   <nav class="navbar background1 h-nav-resp">
    ...
    <div class="d-grip gap-2 col-6 mx-auto text-center p-3 mb-2">
        ...
        <a href="history.php"><button type="button" class="btn-dark btn-lg mb-3">See all Transaction History</button></a>
    </div>
    </div>
 ...
 <div class="container">
        ...
        <br>
            ...
            <br><br>
                ...
                <button class="btn-outline-dark mb-3" name="submit" type="submit" id="myBtn" >Fill the Amount and Transfer</button>
            </div>
        </form>
    </div>    
